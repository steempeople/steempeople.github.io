...
---
title: '[PALKR] 큐레이팅 리워드 16차 배분 및 임대리스트 업데이트 완료 안내'
permlink: palkr-16
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-10-28 12:54:03
categories:
- sct
tags:
- sct
...
안녕하세요, 디온(@donekim)입니다. 큐레이팅 리워드 16차 배분이 다음과 같이 완료되었음을 안내드립니다. 
...
- 큐레이션 수익 합계 : 227.088 PAL
- **배분액 : 113.544 PAL**
- **미배분액(누적) : 1212.788 PAL**
...
![list.png](https://cdn.steemitimages.com/DQmWKTQkRMK8dWadNNCeU7q8Jps8BPQWFiEyuDvNsprbAw9/list.png)

임대량 집계 및 큐레이션 리워드 배분 대상 리스트를 위와 같이 업데이트 되었습니다. 임대자 및 임대수량 집계 및 대조까지 완료하였으나, 혹시라도 누락되었거나 수정이 필요하신 분들은 댓글을 남겨주시면 감사드리겠습니다.

- 총 임대수량 : 37913.783 PAL `(100미만 소량임대자는 집계시 제외)`
- 임대자 : 25명
...
PALKR보팅계정에 PAL토큰을 신규 또는 추가로 임대하고자 하시는 분들은 언제든지 임대 후 댓글을 남겨주시기 바랍니다. `(원하시는 때부터 언제든지 참여가 가능합니다)` 더불어, **큐레이션 수익 17차 배분은 11월 3일(일)에 진행될 예정**입니다. 임대해주신 모든 분들께 감사드립니다.

- - -

This page is synchronized from the post: ['[PALKR] 큐레이팅 리워드 16차 배분 및 임대리스트 업데이트 완료 안내'](https://steemit.com/@donekim/palkr-16)
