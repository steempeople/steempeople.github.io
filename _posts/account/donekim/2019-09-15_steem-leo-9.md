...
---
title: '스팀레오(STEEM LEO) 9차 큐레이션 리워드 배분 및 리스트 업데이트 안내'
permlink: steem-leo-9
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-09-15 02:00:12
categories:
- sct
tags:
- sct
...
![list.png](https://files.steempeak.com/file/steempeak/donekim/3iJi3vuG-list.png)

현재 기준으로 업데이트된 임대자 및 임대수량은 위의 표와 같으며, **9월 22일(일)에 10차 배분이 진행될 예정**임을 안내드립니다. 
...
This page is synchronized from the post: ['스팀레오(STEEM LEO) 9차 큐레이션 리워드 배분 및 리스트 업데이트 안내'](https://steemit.com/@donekim/steem-leo-9)
