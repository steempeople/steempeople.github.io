...
---
title: '[PALKR] 큐레이팅 리워드 4차 배분 및 임대리스트 업데이트 완료 안내'
permlink: palkr-4
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-08-04 09:00:42
categories:
- sct
tags:
- sct
...
![rewards.png](https://files.steempeak.com/file/steempeak/donekim/rMliY9J1-rewards.png)
...
---
![list.png](https://files.steempeak.com/file/steempeak/donekim/YS1u241C-list.png)
...
PALKR보팅계정에 PAL토큰을 신규 또는 추가로 임대하고자 하시는 분들은 언제든지 임대 후 댓글을 남겨주시기 바랍니다. `(원하시는 때부터 언제든지 참여가 가능합니다)` 더불어, **큐레이션 수익 5차 배분은 8월 11일(일)에 진행될 예정**입니다. 임대해주신 모든 분들께 감사드립니다.

- - -

This page is synchronized from the post: ['[PALKR] 큐레이팅 리워드 4차 배분 및 임대리스트 업데이트 완료 안내'](https://steemit.com/@donekim/palkr-4)
