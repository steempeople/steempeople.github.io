...
---
title: '[PALKR] 큐레이팅 리워드 9차 배분 및 임대리스트 업데이트 완료 안내'
permlink: palkr-9
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-09-08 09:00:00
categories:
- sct
tags:
- sct
...
안녕하세요, 디온(@donekim)입니다. 큐레이팅 리워드 9차 배분이 다음과 같이 완료되었음을 안내드립니다. 
...
PALKR보팅계정에 PAL토큰을 신규 또는 추가로 임대하고자 하시는 분들은 언제든지 임대 후 댓글을 남겨주시기 바랍니다. `(원하시는 때부터 언제든지 참여가 가능합니다)` 더불어, **큐레이션 수익 9차 배분은 9월 15일(일)에 진행될 예정**입니다. 임대해주신 모든 분들께 감사드립니다.

- - -

This page is synchronized from the post: ['[PALKR] 큐레이팅 리워드 9차 배분 및 임대리스트 업데이트 완료 안내'](https://steemit.com/@donekim/palkr-9)
