...
---
title: '[이오스 이야기] EOSIO 코드 포크체인 텔로스(TELOS) 토큰 에어그랩(Token Airgrab) 시작!'
permlink: eosio-telos-token-airgrab
catalog: true
toc_nav_num: true
toc: true
position: 9999
date: 2019-02-06 15:02:18
categories:
- coinkorea
tags:
- coinkorea
...
안녕하세요, 디온(@donekim)입니다. 오래간만에 시스터체인`(EOSIO 코드 포크체인)` 텔로스<sub>TELOS</sub>와 관련된 소식을 전달하는 것 같네요. **텔로스는 지난 6,000,000번째 블록에서 오리지날 스냅샷이 완료되었으며 곧 디앱 토큰들의 에어드랍과 에어그랩이 진행될 예정**입니다. 

![viitasphere.jpg](https://cdn.steemitimages.com/DQmUnT8TRXoavm8VuE9oaBuqwcqKVzAEWC7w5m7tFsfagoG/viitasphere.jpg)

> 비타스피어 공식 홈페이지 : https://viitasphere.com/


오늘은 "The Gateway to Financial Freedom"이라는 슬로건과 함께 **텔로스 기반의 지불거래 플랫폼 디앱을 구축하고자 하는 비타스피어(Viitasphere)의 에어그랩을 신청하는 방법**에 대해서 살펴보도록 하겠습니다. `(에어그랩을 신청하기 위해서는 텔로스 계정이 연결되어 있는 스캐터 데스크탑이 설치되어 있어야 합니다)`


![telosportal.png](https://cdn.steemitimages.com/DQmbPdhpDHah8tNm4X7xAXrvrwThP5j7KCNaEQ5Jjz9AugZ/telosportal.png)

① 텔로스포탈(https://portal.telosgermany.io/)에 접속합니다.
> 텔로스포탈은 [이전 포스팅]((https://steemit.com/coinkorea/@donekim/-eosio-telos--1545214121052))에서도 설명드렸던 것처럼 이오스 메인넷의 이오스툴킷(EOStoolkit.io)과 같은 툴킷 사이트라고 생각하시면 됩니다.

![attach account.png](https://cdn.steemitimages.com/DQmYd1Lr1mNPwvuuet8BqD6uwxajcmg289kjg4A3C1pn8Ni/attach%20account.png)

② 좌측 상단에 보이는 `Attach Account`라는 메뉴를 클릭합니다.

<center>![attach account2.png](https://cdn.steemitimages.com/DQmVDu8ZHX9hhy2fYicZdfyHM9ZWx9k88UDbv4Udp5K7EKA/attach%20account2.png)</center>

③ 위와 같이 Telos Mainnet 계정 로그인과 관련된 스캐터 데스크탑 팝업창이 나타나면 `Login`버튼을 클릭해주세요.

![airgrab1.png](https://cdn.steemitimages.com/DQmdR3vXvV5cXNygeYtHLTbJLikUCJB5yzr7rK4Nj3izxBL/airgrab1.png)

④ 로그인이 완료되었으면 텔로스포탈 메뉴 중 `Airgrab Tokens`라는 메뉴를 클릭해주세요

![airgrab2.png](https://cdn.steemitimages.com/DQmfGJEfzSPdqjX52XM8tLjgQJyu8rhXnLiY99QZcyGUY5x/airgrab2.png)

⑤ 위와 같이 VIITA 토큰의 에어그랩(Airgrab)을 신청할 수 있는 메뉴가 있는 것을 확인하실 수 있습니다. 녹색으로 된 `AIRGRAB`이라는 버튼을 클릭해주세요

![airgrab4.png](https://cdn.steemitimages.com/DQmRR2g7sexbSJrtGBZCz85R68QXvpHqJSKfyPCXp6W49cC/airgrab4.png)

⑥ 위와 같이 스캐터 데스크탑의 팝업창이 나타나면 `Allow`버튼을 클릭해주세요

![airgrab5.png](https://cdn.steemitimages.com/DQmXM1uwMtWTfDxz75jMHJHGcP3ZrP89osEbtLhPhWgsrHS/airgrab5.png)

⑦ 위와 같은 화면이 나타나면 정상적으로 VIITA토큰 에어그랩 신청이 모두 완료된 것입니다. 


**에어그랩을 신청하는 경우 계정당 75개의 VIITA토큰**을 받게 됩니다. (`물론 에어그랩을 신청하자마자 바로 지급되는 것은 아니고, 아직까지 정확한 토큰 배포 일자는 확인하지 못했습니다)` 현재 Viitasphere의 공식 홈페이지에 알려진 정보에 따르면 **VIITA토큰의 프리세일이 2019년 9월에 예정되어 있고, 프리세일 기준 금액은 토큰당 $0.01로 진행될 예정**이라고 하기 때문에 75개의 VIITA토큰은 약 800원 정도 밖에 되지 않는 수량입니다. 혹시라도 관심있는 분들께서는 심심풀이로 에어그랩을 신청해보시길 바랍니다 :)
...
This page is synchronized from the post: ['[이오스 이야기] EOSIO 코드 포크체인 텔로스(TELOS) 토큰 에어그랩(Token Airgrab) 시작!'](https://steemit.com/@donekim/eosio-telos-token-airgrab)
